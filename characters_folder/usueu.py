...
usueu.status = {"nowhp": 100, "maxhp":100, "atk": 50, "def":20, "speed": 100, "condition":[], "origin_atk":50, "origin_def" : 15, "origin_speed":100}  # nowhp, maxhp, attack, speed
...
usueu.skill_2_sound = load_wav('source\\sound\\buff.mp3')
usueu.skill_2_sound.set_volume(32)
usueu.skill_3_sound = load_wav('source\\sound\\usueu3.mp3')
usueu.skill_3_sound.set_volume(32)
