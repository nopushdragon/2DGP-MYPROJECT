...
myau.skill_2_sound = load_wav('source\\sound\\debuff.mp3')
myau.skill_2_sound.set_volume(32)
myau.skill_3_sound = load_wav('source\\sound\\buff.mp3')
myau.skill_3_sound.set_volume(32)
