...
gunman = Character([
    [load_image(f'source\\character\\hope\\hope04_0{i}.png')for i in range(1, 3)],
    [load_image(f'source\\character\\hope\\hope04_0{i}.png') for i in range(3, 5)],
    [load_image(f'source\\character\\hope\\hope04_0{i}.png') for i in range(5, 8)]
], 100, 400, [],name = "건 맨", get = True,flip = True)
gunman.status = {"nowhp": 100, "maxhp":750, "atk": 50, "def":20, "speed": 130, "condition":[], "origin_atk":105, "origin_def" : 70, "origin_speed":160}  # nowhp, maxhp, attack, speed
...
gunman.skill_2_sound = load_wav('source\\sound\\gunman2.mp3')
gunman.skill_2_sound.set_volume(32)
gunman.skill_3_sound = load_wav('source\\sound\\gunman3.mp3')
gunman.skill_3_sound.set_volume(32)
