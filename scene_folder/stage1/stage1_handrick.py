...
handrick = Character([
    [load_image(f'source\\character\\handrick\\handrick04_0{i}.png') for i in range(1, 3)],
    [load_image(f'source\\character\\handrick\\handrick04_0{i}.png') for i in range(3, 5)],
    [load_image(f'source\\character\\handrick\\handrick04_0{i}.png') for i in range(5, 8)]
], 100, 400, [],name = "핸드릭",flip=True)

handrick.illust = load_image('source\\character\\handrick\\hero_illust_02_Handrick.png')

handrick.status = {"nowhp": 100, "maxhp":850, "atk": 50, "def":20, "speed": 88, "condition":[], "origin_atk":88, "origin_def" : 90, "origin_speed":150}  # nowhp, maxhp, attack, speed
