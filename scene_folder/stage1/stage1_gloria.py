...
gloria = Character([
    [load_image(f'source\\character\\gloria\\gloria04_0{i}.png') for i in range(1, 3)],
    [load_image(f'source\\character\\gloria\\gloria04_0{i}.png') for i in range(3, 5)],
    [load_image(f'source\\character\\gloria\\gloria04_0{i}.png') for i in range(5, 8)]
], 100, 400, [],name = "글로리아", flip = True)

gloria.illust = load_image('source\\character\\gloria\\hero_illust_17_Gloria.png')

gloria.status = {"nowhp": 100, "maxhp":760, "atk": 50, "def":20, "speed": 124, "condition":[], "origin_atk":110, "origin_def" : 77, "origin_speed":150}  # nowhp, maxhp, attack, speed
