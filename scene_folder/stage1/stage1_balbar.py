...
balbar = Character([
    [load_image(f'source\\character\\balbar\\balbar04_0{i}.png') for i in range(1, 3)],
    [load_image(f'source\\character\\balbar\\balbar04_0{i}.png') for i in range(3, 5)],
    [load_image(f'source\\character\\balbar\\balbar04_0{i}.png') for i in range(5, 8)]
], 100, 400, [],name = "발바",flip = True)

balbar.illust = load_image('source\\character\\balbar\\hero_illust_06_Balbar.png')

balbar.status = {"nowhp": 100, "maxhp":800, "atk": 20, "def":20, "speed": 85, "condition":[], "origin_atk":80, "origin_def" : 60, "origin_speed":131}  # nowhp, maxhp, attack, speed
