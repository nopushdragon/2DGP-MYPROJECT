...
luna = Character([
    [load_image(f'source\\character\\luna\\luna04_0{i}.png') for i in range(1, 3)],
    [load_image(f'source\\character\\luna\\luna04_0{i}.png') for i in range(3, 5)],
    [load_image(f'source\\character\\luna\\luna04_0{i}.png') for i in range(5, 8)]
], 100, 400, [],name = "루나",flip= True)

luna.illust = load_image('source\\character\\luna\\hero_illust_10_Luna.png')

luna.status = {"nowhp": 100, "maxhp":690, "atk": 50, "def":20, "speed": 104, "condition":[], "origin_atk":110, "origin_def" : 67, "origin_speed":145}  # nowhp, maxhp, attack, speed
