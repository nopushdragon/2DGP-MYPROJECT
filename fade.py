...
black_fade_image = load_image('source\\background\\black.png')
...
def draw():
    if fade_state != STATE_IDLE:
        ...
        black_fade_image.clip_draw(0, 0, 1200, 800, gamemanager.WIDTH // 2, gamemanager.HEIGHT // 2)
